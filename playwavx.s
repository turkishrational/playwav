; ****************************************************************************
; playwavx.asm (for TRDOS 386)
; ----------------------------------------------------------------------------
; PLAYWAVX.PRG ! Sound Blaster 16 .WAV PLAYER program by Erdogan TAN
;
; 24/11/2024
;
...
; playwav9.s (14/12/2024)
; sb16play.s (18/12/2024)
; ac97play.s (14/12/2024)
; sb16play.asm (07/12/2024)
...
_STARTUP:
	...
	call	DetectSB16
	; 18/12/2024
	jnc	short GetFileName_@ ; 07/12/2024 (playwav9.s)
...
getwavparms:
	...
	; 18/12/2024 (playwavx.s, sb16play.s)
...
wleds_sa_2:
	...
	; 26/11/2023
	;sys	_audio, 0200h, [buffersize], audio_buffer
	jc	short error_exit ; 07/12/2024
...
msg_usage:
	db	'usage: playwavx filename.wav',10,13,0 ; 18/12/2024
