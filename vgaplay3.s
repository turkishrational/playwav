; ****************************************************************************
; vgaplay3.s - TRDOS 386 (TRDOS v2.0.9) WAV PLAYER - VESA VBE Video Mode 101h
; ----------------------------------------------------------------------------
; VGAPLAY3.PRG ! AC'97 (ICH) .WAV PLAYER program by Erdogan TAN
;
...
StartPlay@:
	...
	cmp	byte [VRA], 0
	jna	short _w1 ; 48kHZ (interpolation)
	;;;
	; 01/12/2024 (32bit)
...
; 05/02/2025 - cgaplay.s - cgaplay1.s - vgaplay3.s
...
msgAudioCardInfo:
	...
	; 27/12/2024
msg_usage:
	db 'usage: VGAPLAY3 <FileName1> <FileName2> <...>',10,13,0
