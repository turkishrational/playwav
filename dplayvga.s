; ****************************************************************************
; dplayvga.s - TRDOS 386 (TRDOS v2.0.3) Test Program - 'sysvideo' pixel tests
; ----------------------------------------------------------------------------
; DPLAYVGA.PRG ! AC'97 (ICH) .WAV PLAYER program by Erdogan TAN
;
; 21/12/2024
;
...
;
; ****************************************************************************
; nasm dplayvga.s -l dplayvga.txt -o DPLAYVGA.PRG -Z error.txt
...
msgAudioCardInfo:
	...
	; 21/12/2024
msg_usage:
	db 'usage: dplayvga filename.wav',10,13,0
...
program_msg:
	db "TRDOS 386 v2.0.9 - ('sysvideo') Test Program - Dos Player"
	db 0Dh, 0Ah
	db "by Erdogan Tan - 22/12/2024"
	db 0Dh, 0Ah, 0Dh, 0Ah
