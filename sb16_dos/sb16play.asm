; ****************************************************************************
; sb16play.asm (for Retro DOS)
; ----------------------------------------------------------------------------
; SB16PLAY.COM ! Sound Blaster 16 (DOS) .WAV PLAYER program by Erdogan TAN
;
; 29/11/2024
;
...
;
; Assembler: FASM 1.73
;	     fasm sb16play.asm SB16PLAY.COM	
; ----------------------------------------------------------------------------
...
; playwav9.asm (27/11/2024) -- ref: ac97play.asm, 29/11/2024 --
