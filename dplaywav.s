; ****************************************************************************
; dplaywav.s - TRDOS 386 (TRDOS v2.0.9) WAV PLAYER - VESA VBE Video Mode 101h
; ----------------------------------------------------------------------------
; DPLAYWAV.PRG ! AC'97 (ICH) .WAV PLAYER program by Erdogan TAN
;
; 21/12/2024
;
; [ Last Modification: 26/12/2024 ]
;
; Modified from PLAYWAV9.PRG .wav player program by Erdogan Tan, 18/12/2024
;
; ****************************************************************************
; nasm dplaywav.s -l dplaywav.txt -o DPLAYWAV.PRG -Z error.txt
