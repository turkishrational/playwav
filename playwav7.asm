; ****************************************************************************
; playwav7.asm (for Retro DOS)
; ----------------------------------------------------------------------------
; PLAYWAV7.COM ! AC'97 (ICH) .WAV PLAYER program by Erdogan TAN
;
; 13/11/2024
;
...
;
; Assembler: FASM 1.73
;	     fasm playwav7.asm PLAYWAV7.COM	
; ----------------------------------------------------------------------------

; playwav6.asm (30/05/2024)
...
msg_usage:
	db	'usage: playwav7 filename.wav',10,13,0 ; 30/05/2024
...
smpRBuff:	rw 14 ; 19/11/2016 - Erdogan Tan
